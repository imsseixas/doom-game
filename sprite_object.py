...
class SpriteObject:
    def __init__(self, game, path = 'sprites/static_sprites/candlebra.png', pos = (10.5, 3.5), scale = 0.7, shift=0.27):
        self.game = game
...
class AnimatedSprite(SpriteObject):
    def __init__(self, game, path = 'sprites/animated_sprites/green_light/0.png', pos = (11.5, 3.5), scale=0.8, shift=0.15, animation_time=120):
